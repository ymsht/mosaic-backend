...
type Art struct {
	...
	ArtNameEn            sql.NullString `db:"art_name_en" json:"art_name_en"`
	YearOfProductionFrom sql.NullString `db:"year_of_production_from" json:"year_of_production_from"`
	YearOfProductionTo   sql.NullString `db:"year_of_production_to" json:"year_of_production_to"`
...
select 
  ...
  DATE_FORMAT(art.year_of_production_from, '%Y') year_of_production_from,
  DATE_FORMAT(art.year_of_production_to, '%Y') year_of_production_to,
  art.evaluation, 
  art.height, 
  art.width, 
  art.file_url, 
